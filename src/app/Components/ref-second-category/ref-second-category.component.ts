...
@Component({
  selector: 'app-ref-second-category',
  templateUrl: './ref-second-category.component.html',
  styleUrls: ['./ref-second-category.component.css']
})
export class RefSecondCategoryComponent implements OnInit {
