...
@Component({
  selector: 'app-ref-fifth-category',
  templateUrl: './ref-fifth-category.component.html',
  styleUrls: ['./ref-fifth-category.component.css']
})
export class RefFifthCategoryComponent implements OnInit {
  successfull: string;
  obj:ReferenceId;
  //detailsData: string='';
  msg: string;
  ...
  ngOnInit() {
    ...
    console.log(this.detailsData,"---------------------details---------------");
