...
@Component({
  selector: 'app-sixth-catog',
  templateUrl: './sixth-catog.component.html',
  styleUrls: ['./sixth-catog.component.css']
})
export class SixthCatogComponent implements OnInit {
  diagnosed:string='';
  selectedOpt: string='';
  example:string='';
  msg:any;
...
;
 ...
 listDrop:any;
  ...
  ngOnInit(): void {
    ...
    //disabling letter e from input field start
  ...
  //   WeightBox.addEventListener("keydown", function(e) {
  //     if (invalidChars.includes(e.key)) {
  //       e.preventDefault();
  //     }
  //   });

  //   var HeightBox = document.getElementById("length");
  //   var invalidChars = [
  //     "-",
  //     "+",
  //     "e",
  ...
  //     }
  //   });
  //   var BmiBox = document.getElementById("bmi");
  //   var invalidChars = [
  //     "-",
  //     "+",
  //     "e",
  ...
  //   BmiBox.addEventListener("keydown", function(e) {
  //     if (invalidChars.includes(e.key)) {
  //       e.preventDefault();
  //     }
  //   });

  //   var PulseBox = document.getElementById("pulseRate");
  //   var invalidChars = [
  //     "-",
  //     "+",
  //     "e",
  ...
  //   PulseBox.addEventListener("keydown", function(e) {
  //     if (invalidChars.includes(e.key)) {
  //       e.preventDefault();
  //     }
  //   });

  //   var RespiratoryBox = document.getElementById("respiratoryRate");
  //   var invalidChars = [
  //     "-",
  //     "+",
  //     "e",
  ...
  //   RespiratoryBox.addEventListener("keydown", function(e) {
  //     if (invalidChars.includes(e.key)) {
  //       e.preventDefault();
  //     }
  //   });

  //   var BpBox = document.getElementById("bp");
  //  var invalidChars = [
  //    "-",
  //    "+",
  //    "e",
  ...
  //  BpBox.addEventListener("keydown", function(e) {
  //    if (invalidChars.includes(e.key)) {
  //      e.preventDefault();
  //    }
  //  });
...
//   var info=new SixthCategory();
//   info.patientId=this.detailsData.memberId;

//   info.category=categoryForm;
...
//   info.respiratoryRate=Number(this.formFieldsData.get("respiratoryRate").value);
...
if (this.checkedValue.value.selectAll) {
  ...
  info.neutrophilsChecks = this.checkedValue.value.dlcChecks ? "sent" : "not sent";
  info.lymphocytesChecks = this.checkedValue.value.dlcChecks ? "sent" : "not sent";
  info.monocytesChecks = this.checkedValue.value.dlcChecks ? "sent" : "not sent";
  info.eosinophilsChecks = this.checkedValue.value.dlcChecks ? "sent" : "not sent";
  info.basophilsChecks = this.checkedValue.value.dlcChecks ? "sent" : "not sent";
  ...
  info.meanCorpuscularHemoglobinConcentrationChecks = this.checkedValue.value.meanCorpusHemoglobinConcenChecks ? "sent" : "not sent";
  ...
  info.rbcChecks = this.checkedValue.value.rbcCountChecks ? "sent" : "not sent";
  info.urineRoutineExamChecks = this.checkedValue.value.urineRoutineExaminationChecks ? "sent" : "not sent";
