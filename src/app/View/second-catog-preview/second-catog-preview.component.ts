...
@Component({
  selector: 'app-second-catog-preview',
  templateUrl: './second-catog-preview.component.html',
  styleUrls: ['./second-catog-preview.component.css']
})
export class SecondCatogPreviewComponent implements OnInit {
  patientRecord:any;
  patientMemberId:any;
