...
@Component({
  selector: 'app-third-catog-preview',
  templateUrl: './third-catog-preview.component.html',
  styleUrls: ['./third-catog-preview.component.css']
})
export class ThirdCatogPreviewComponent implements OnInit {
  patientRecord:any;
  patientMemberId:any;
