...
@Component({
  selector: 'app-fifth-catog-preview',
  templateUrl: './fifth-catog-preview.component.html',
  styleUrls: ['./fifth-catog-preview.component.css']
})
export class FifthCatogPreviewComponent implements OnInit {
  patientRecord:any;
  patientMemberId:any;
