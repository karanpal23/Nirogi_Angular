...
@Component({
  selector: 'app-first-catog-preview',
  templateUrl: './first-catog-preview.component.html',
  styleUrls: ['./first-catog-preview.component.css']
})
export class FirstCatogPreviewComponent implements OnInit {
  patientRecord:any;
  patientMemberId:any;
